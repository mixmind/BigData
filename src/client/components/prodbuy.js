        ...
        <Fragment>
          <div className={this.state.showGraph ? 'container' : ''}>
            ...
            <div className="data-to-pick">
              ...
              />
              <p>
                <DatePicker selected={this.state.endDate} onChange={this.handleChangeEnd} className="date" dateFormat="dd/MM/yyyy" />
:ל
                {' '}
              </p>
              <p>
                <DatePicker selected={this.state.startDate} onChange={this.handleChangeStart} className="date" dateFormat="dd/MM/yyyy" />
:מ
                {' '}
              </p>
